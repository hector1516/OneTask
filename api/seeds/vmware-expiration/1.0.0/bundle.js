var vmwareExpiration = { id: 'vmware-expiration', version: '1.0.0', run: async function(params, ctx) {
  ...
  var ps = [
    ...
    'for ($i = 0; $i -lt 11; $i++) { TypeKeys "{TAB}"; Start-Sleep -Milliseconds 200 }',
    'Start-Sleep -Milliseconds 500',

    '# 8. Down x6 to expiration',
    'for ($i = 0; $i -lt 6; $i++) { TypeKeys "{DOWN}"; Start-Sleep -Milliseconds 200 }',
    'Start-Sleep -Milliseconds 500',

    '# 9. Tab x8 to month field',
    'for ($i = 0; $i -lt 8; $i++) { TypeKeys "{TAB}"; Start-Sleep -Milliseconds 200 }',
    'Start-Sleep -Milliseconds 500',
