var vmwareExpiration = { id: 'vmware-expiration', version: '1.0.0', run: async function(params, ctx) {
  ...
  var ps = [
    ...
    '# Step 4: Find Settings dialog - search ALL windows from vmware process',
    '$debug += "STEP=4_FIND_SETTINGS"',
    'Start-Sleep -Seconds 1',
    '',
    '$settingsHwnd = [IntPtr]::Zero',
    '$allProcs = Get-Process -Name "vmware" -ErrorAction SilentlyContinue',
    ...
    '        $t = $sb.ToString()',
    '        if ($t -match "Virtual Machine Settings") {',
    '          $settingsHwnd = $hwnd',
    '          break',
    '        }',
    '      }',
    '    }',
    '  } while ($hwnd -ne [IntPtr]::Zero -and $settingsHwnd -eq [IntPtr]::Zero)',
